...
urlpatterns = [
    ...
    url(r'estadisticas_nacionales/', views.HomeEstadisticasNacionalesView.as_view(),name="estadisticas_nacionales"),
    url(r'^estadistica/list/$', views.HomeEstadisticasListView.as_view(),name="estadistica_list"),
    url(r'^estadistica/create/$', views.EstadisticaCreate.as_view(success_url='/estadisticas/list/'), name='estadistica_create'),
    ...
    url(r'^documento/create/$', views.DocumentoCreate.as_view(success_url='/biblioteca/'), name='documento_create0'),
    url(r'^documento/(?P<pk>\d+)/update/$', views.DocumentoUpdate.as_view(success_url='/biblioteca/'), name='documento_update0'),
    url(r'^documento/(?P<pk>\d+)/delete/$', views.DocumentoDelete.as_view(success_url='/biblioteca/'), name='documento_delete0'),
#    url(r'^documento/create/(?P<tipo>0)/$', views.DownloadDocumentCreate.as_view(success_url='/biblioteca/'), name='documento_create0'),
#    url(r'^documento/create/(?P<tipo>1)/$', views.DownloadDocumentCreate.as_view(success_url='/biblioteca/'), name='documento_create1'),
#    url(r'^documento/create/(?P<tipo>2)/$', views.VideoCreate.as_view(success_url='/biblioteca/'), name='documento_create2'),
...
#    url(r'^documento/(?P<pk>\d+)/update/(?P<tipo>1)/$', views.DownloadDocumentUpdate.as_view(success_url='/biblioteca/'), name='documento_update1'),
#    url(r'^documento/(?P<pk>\d+)/update/(?P<tipo>2)/$', views.VideoUpdate.as_view(success_url='/biblioteca/'), name='documento_update2'),
#    url(r'^documento/(?P<pk>\d+)/delete/(?P<tipo>0)/$', views.DocumentoDelete.as_view(success_url='/biblioteca/'), name='documento_delete0'),
#    url(r'^documento/(?P<pk>\d+)/delete/(?P<tipo>1)/$', views.DocumentoDelete.as_view(success_url='/biblioteca/'), name='documento_delete1'),
#    url(r'^documento/(?P<pk>\d+)/delete/(?P<tipo>2)/$', views.DocumentoDelete.as_view(success_url='/biblioteca/'), name='documento_delete2'),
